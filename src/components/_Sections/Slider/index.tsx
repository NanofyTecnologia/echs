...
export default function Slider() {
  return (
    <section className="mt-2 border-t-[24px] border-secondary pt-2">
      <Swiper
        centeredSlides={true}
        autoplay={{
          delay: 5000,
        ...
        <SwiperSlide>
          ...
          <div className="absolute inset-0 flex items-center justify-center md:ml-24 md:justify-start">
            <div className="space-y-1">
              <div className="bg-black bg-opacity-70 p-2 font-semibold uppercase text-white md:text-2xl">
                diferencial no mundo dos negócios
              </div>
              <div className="bg-black bg-opacity-70 p-2 text-xs text-white md:text-base">
        ...
        <SwiperSlide>
          ...
          <div className="absolute inset-0 flex items-center justify-center md:mr-24 md:justify-end">
            <div className="space-y-1">
              ...
              <div className=" bg-black bg-opacity-70 p-2 text-xs text-white md:text-end md:text-base">
        ...
        <SwiperSlide>
          ...
          <div className="absolute inset-0 flex items-center justify-center md:mr-24 md:justify-end md:text-end">
            <div className="space-y-1">
              ...
              <div className=" bg-black bg-opacity-70 p-2 text-[10px] text-white md:text-end md:text-base">
